...
<main>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
        <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Categorys</h2>
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{route('shop.product.details',["product_slug"=>$randomProduct->slug])}}">
                        <img loading="lazy" src="{{asset('uploads/products')}}/{{$randomProduct->image}}" width="258" height="313"
                    ...
                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="{{route('shop.product.details',["product_slug"=>$randomProduct->slug])}}">{{$randomProduct->name}}</a></h6>
                      <div class="product-card__price d-flex">
                        {{-- <span class="money price text-secondary">$62</span> --}}
                        <span class="money price text-secondary">
                          @if($randomProduct->sale_price && $randomProduct->sale_price < $randomProduct->regular_price)                    
                              <s>${{ $randomProduct->regular_price }}</s> 
                              ${{ $randomProduct->sale_price }} 
                              {{ round(($randomProduct->regular_price - $randomProduct->sale_price) * 100 / $randomProduct->regular_price) }}% OFF
                          @else
                              ${{ $randomProduct->regular_price }}
                          @endif
                      </span>
                      </div>
